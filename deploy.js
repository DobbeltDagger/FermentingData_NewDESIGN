...
ftpDeploy
  .deploy(dConf) // config)
  // .then(res => console.log("Uploading is finished, Magda!"))
  .then(res => {
    console.log(" ");
    console.log(' /$$   /$$           /$$                           /$$ /$$                           /$$          ');
    console.log('| $$  | $$          | $$                          | $$|__/                          |__/          ');
    ...
    console.log('| $$  |__/ /$$ /$$$$$$$  /$$  /$$$$$$$| $$$$$$$   /$$$$$$   /$$$$$$$      | $$$$  /$$$$  /$$$$$$   /$$$$$$   /$$$$$$$  /$$$$$$ | $$');
    console.log('| $$$$    | $$| $$__  $$| $$ /$$_____/| $$__  $$ /$$__  $$ /$$__  $$      | $$ $$/$$ $$ |____  $$ /$$__  $$ /$$__  $$ |____  $$| $$');
    console.log('| $$_/    | $$| $$  | $$| $$|  $$$$$$ | $$  | $$| $$$$$$$$| $$  | $$      | $$  $$$| $$  /$$$$$$$| $$  | $$| $$  | $$  /$$$$$$$|__/');
    console.log('| $$      | $$| $$  | $$| $$ |____  $$| $$  | $$| $$_____/| $$  | $$      | $$|  $ | $$ /$$__  $$| $$  | $$| $$  | $$ /$$__  $$    ');
    console.log('| $$      | $$| $$  | $$| $$ /$$$$$$$/| $$  | $$|  $$$$$$$|  $$$$$$$      | $$ |/  | $$|  $$$$$$$|  $$$$$$$|  $$$$$$$|  $$$$$$$ /$$');
    console.log('|__/      |__/|__/  |__/|__/|_______/ |__/  |__/ |_______/ |_______/      |__/     |__/ |_______/ |____  $$ |_______/ |_______/|__/');
    console.log('                                                                                                  /$$  | $$                        ');
    console.log('                                                                                                 |  $$$$$$/                        ');
    console.log('                                                                                                  |______/                         ');
  })
